...
const SocialMediaSection = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center bg-black pb-8">
      <SectionTitle 
        title="Follow us on Social Media for more"
        ...
        {social.map((item) => (
          ...
          >
            <svg 
              ...
              viewBox="0 0 24 24" 
              fill="white"
              className={`transition-colors ${item.name === 'Instagram' ? 'hover:fill-pink-400' : 'hover:fill-blue-400'}`}
            >
              {item.icon}
            </svg>
          </a>
