      ...
      <div className="py-16 px-4 bg-white">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg mb-8 text-black">
            Perfect Kitchen Robes is a family-owned business with over 15 years of experience in designing and installing custom kitchen and wardrobe solutions throughout Melbourne.
          </p>
          <p className="text-lg mb-8 text-black">
