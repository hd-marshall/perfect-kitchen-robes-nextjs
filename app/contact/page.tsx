      ...
      <div className="py-16 px-4 md:px-8 bg-white">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="flex flex-col md:flex-row gap-12">
            ...
            {/* Phone - Now clickable */}
            <div className="flex items-center">
                <a href="tel:0393577204" className="flex items-center group">
                  ...
                  <div className="ml-6">
                    <p className="text-xl font-medium text-gray-800 group-hover:text-gray-600 transition-colors">03 9357-7204</p>
